...
namespace IngSoftware.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Inventario,Cantidad,Descripcion,ID_Salon,ID_Equipo")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Inventario,Cantidad,Descripcion,ID_Salon,ID_Equipo")] Inventario inventario)
        {
            if (ModelState.IsValid)
            {
